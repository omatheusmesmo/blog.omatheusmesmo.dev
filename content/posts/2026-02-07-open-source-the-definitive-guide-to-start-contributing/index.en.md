...
cover:
  ...
  caption: "Contributing to the global community"
  relative: true
---
...
* **`good first issue`** / **`up for grabs`**: Ideal tasks for newcomers.
* **`help wanted`**: The project needs extra hands on something specific.
...
* **[Jakarta EE](https://github.com/jakartaee):** Where Java Enterprise standards are defined.
* **[Quarkus](https://github.com/quarkusio/quarkus):** The Kubernetes-native Java framework. Also, explore its [extensions](https://github.com/quarkiverse).
* **[Spring Boot](https://github.com/spring-projects/spring-boot):** The most popular framework in the Java ecosystem.

### Translation and Community Level
* **[pt.quarkus.io](https://github.com/quarkusio/pt.quarkus.io):** Specifically focused on translating official documentation into Portuguese. Perfect for helping the local community.

### Lab Level
* **[BuildCLI](https://github.com/BuildCLI/BuildCLI):** A developer-friendly CLI tool for Java automation that I created with friends. Being a smaller project, it's an excellent environment to practice unit testing and bug reporting without pressure.

## 8. Career Impact

Contributing opens doors:
1.  **Market Visibility:** Proves your code has passed through rigorous peer reviews.
2.  **True Specialization:** You understand "low-level" details that daily corporate work rarely demands.
3.  **Networking:** Direct interaction with the creators of the tools used worldwide.
